  ...
  return (
    <div className="homepage-body">
      <div className="top-left-blob-container">
        <img src={TopLeftBlob} className="top-left-blob"/>
      </div>
      <div className="bottom-right-blob-cotainer">
        <img src={BottomRightBlob} className="bottom-right-blob"/>
      </div>
        ...
        <p>
          ...
          <span>
            <a
              ...
              style={{ textDecoration: "none", color: "#00BFFF", paddingLeft: "0.25em"}}
            >
              on Github
            </a>
          </span>
